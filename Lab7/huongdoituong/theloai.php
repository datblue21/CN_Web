...
if (count($theloai_arr) == 0) {
    $theloai_html = 'Không có thể
loại <a href="theloai_them.php">THÊM THỂ LOẠI</a>';
} else {
    ...
    foreach ($theloai_arr as $item) {
        ...
        $theloai_html .= '<td><a href="delete.php?id= ' . $item['idTL'] . '" onclick="return confirm(\'Bạn có thực
...
<body>
<div class="container"> <?php echo $theloai_html; ?>
</div>
</body>
</html>